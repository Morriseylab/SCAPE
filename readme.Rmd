...
=======
<span style="color: red;">**WARNING Do not use!!! Not fully functional</span>
>>>>>>> 3d45abd0c95ce4177165719ba251a4de03d765aa


# SCAPE 0.1.0

SCAPE is a tool that will create a network like visualization of the following interaction between 2 cells/cluster using scRNA-seq and scATAC-seq data. 
