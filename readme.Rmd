...
SCAPE is a tool that will create a network like visualization of teh following interaction between 2 cells/cluster using scRNA-seq and scATAC-seq data. 
